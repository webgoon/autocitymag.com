...
if(isset($_GET['id'])){
  $colname_filter_id =  mysqli_escape_string($autocity_connection_mysqli, trim($_GET['id']));
  //$sql_where =  "AND `vehicles`.`vmodel` LIKE '%$colname_filter_srch%' ";
  $sql_where_query_vehicles .= " `vehicles`.`did` = '$colname_filter_id' AND " ;
...
LEFT JOIN `idsids_idsdms`.`dealers`
 ...
 WHERE `vehicles`.`vlivestatus` = '1' AND `dealers`.`id` = `vehicles`.`did` AND $sql_where_query_vehicles `vehicles`.`vthubmnail_file` IS NOT NULL GROUP BY `vehicles`.`vid` ORDER BY RAND() LIMIT 50";
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-sm-12 justify-content-center text-center">
                        <h1 class="text-white c-font-weight-700">Grid Vehicle Listing</h1>
                    </div>
                </div>
            </div>
        </section>
...
?>
                            ...
                            <div class="col-12 col-md-6 col-lg-12 col-xl-6 mb-4">
                                <a href="#"><img src="<?php echo $truepic; ?>" alt="" class="img-fluid rounded-top" /></a>
                                <div class="card c-brd-light car-box">
                                    <div class="card-body">
                                        ...
                                        <ul class="list-unstyled mb-0 c-line-height-2_5">
                                            <li><h6 class="c-primary mb-0"><small class="c-light">Price</small> $ <?php echo formatMoney($row_filter_vehicles['vrprice']); ?> </h6></li>
                                            <li><i class="fa fa-map-marker pr-1"></i> <?php echo $row_filter_vehicles['city']; ?>, <?php echo $row_filter_vehicles['state']; ?> - <?php echo $row_filter_vehicles['zip']; ?></li>
                                        </ul>
                                    </div>
                                    <ul class="list-inline mb-0 p-3 c-brd-light border border-left-0 border-bottom-0 border-right-0">
                                        <li class="list-inline-item mr-3"><a href="#" class="c-light"><i class="flaticon-calendar pr-1"></i> <?php  echo $year; ?> </a></li>
                                        <li class="list-inline-item mr-3"><a href="#" class="c-light"><i class="flaticon-clock pr-1"></i>  <?php echo formatMoney($row_filter_vehicles['vmileage']); ?></a></li>
